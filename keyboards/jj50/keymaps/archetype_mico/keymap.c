...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT( \
      ...
      //,----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+|
      //|          |           |           |           |           |           |           |           |           |           |           |           |
       LT(_NUMS,KC_ESC),KC_A,      KC_S,        KC_D,      KC_F,       KC_G,        KC_H,       KC_J,      KC_K,       KC_L,      KC_SCLN,    KC_QUOT, \
      //|          |           |           |           |           |           |           |           |           |           |           |           |
      //,----------+-----------+-----------+----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+|
      //|          |           |           |           |           |           |           |           |           |           |           |           |
    ...
    [_ARROWS] = LAYOUT(                                                   \
      ...
      //,----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+|
      //|          |           |           |           |           |           |           |           |           |           |           |           |
          _______,   KC_LEFT,     KC_DOWN,    KC_RIGHT,   _______,    _______,   _______,    _______,    _______,     _______,    KC_PWD,    _______,  \
      //|          |           |           |           |           |           |           |           |           |           |           |           |
      //,----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+'
      //|          |           |           |           |           |           |           |           |           |           |           |           |
          _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______,    _______,    _______,    _______,    _______,  \
    ...
    [_FPAD] = LAYOUT( \
      ...
      //,----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+|
      //|          |           |           |           |           |           |           |           |           |           |           |           |
          KC_PLUS,    KC_TILD,    KC_PIPE,    KC_BSLS,    KC_SLSH,    _______,   _______,     _______,    _______,    _______,    _______,   _______, \
      //|          |           |           |           |           |           |           |           |           |           |           |           |
      //,----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+|
      //|          |           |           |           |           |           |           |           |           |           |           |           |
          KC_MINS,    KC_LPRN,    KC_RPRN,     KC_LT,      KC_GT,     _______,   _______,     _______,    _______,    _______,    _______,   _______, \
      //|          |           |           |           |           |           |           |           |           |           |           |           |
      //,----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+'
      //|          |           |           |           |           |           |           |           |           |           |           |           |
          KC_UNDS,    KC_LBRC,    KC_RBRC,    KC_LCBR,    KC_RCBR,    _______,   _______,     _______,    _______,    _______,    _______,   KC_PGUP, \
      //|          |           |           |           |           |           |           |           |           |           |           |           |
      //,----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+|
      //|          |           |           |           |           |           |           |           |           |           |           |           |
           KC_EQL,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_HOME,    KC_PGDN,    KC_END    \
      //|          |           |           |           |           |           |           |           |           |           |           |           |
      //,----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+|
    ),
